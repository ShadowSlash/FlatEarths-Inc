    ...
    return (
        <aside className="min-w-fit p-4 flex flex-col">
            ...
            <div className="flex flex-col mb-6">
                <h3 className="font-bold text-2xl text-[#48D591] mb-5">Newest Conspiracies </h3>
                <nav>
                    <ul>
                ...
                <h3 className="font-bold text-2xl text-[#48D591] mt-6 mb-4">Settings</h3>
                    <nav>
                        <ul>
            ...
            <div className="mt-auto">
                        <h3 className="font-bold text-xl text-[#48D591] mb-4">My Posts</h3>
                <nav>
                    <ul>
